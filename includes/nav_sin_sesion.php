<div class="nav">
  ...
  <div class="nav_list">
    ...
    <div class="nav_item"><a href="https://HubGames.es/vistas/login_vista.php">Iniciar sesión</a></div>
    <div class="nav_item"><a href="https://HubGames.es/vistas/registro_vista.php">Registrarse</a></div>
  </div>
</div>